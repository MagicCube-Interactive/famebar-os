...
import { User, Mail, Phone, MapPin, Zap, Shield, Copy, Check } from 'lucide-react';
    ...
    <div className="space-y-6 max-w-2xl">
      ...
      <div className="rounded-lg border border-gray-700/50 bg-gradient-to-br from-gray-800/50 to-gray-900/30 p-8">
        <div className="mb-8 flex flex-col items-center gap-6 lg:flex-row lg:items-start">
          {/* Avatar */}
          <div className="flex h-24 w-24 flex-shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-amber-400 to-yellow-500">
        ...
        <div className="grid grid-cols-3 gap-3 border-t border-gray-700/30 pt-6">
          ...
          <div>
            ...
            <p className="mt-2 text-lg font-bold text-amber-400">{ambassador.totalRecruits}</p>
          </div>
          <div>
      ...
      <div className="rounded-lg border border-gray-700/50 bg-gradient-to-br from-gray-800/50 to-gray-900/30 p-6">
        ...
        <button className="mt-6 w-full rounded-lg border border-amber-500/50 bg-amber-500/10 px-4 py-2.5 text-sm font-semibold text-amber-300 transition-all duration-200 hover:bg-amber-500/20">
